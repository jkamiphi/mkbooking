        ...
        <>
            ...
            <div className="fixed bottom-5 left-0 right-0 z-50 flex justify-center pointer-events-none">
                <div
                    ...
                    style={{
                        animation: "selectionBarSlideUp 0.35s cubic-bezier(0.22, 1, 0.36, 1) forwards",
                    }}
                >
                    {/* Expanded panel */}
                    {isExpanded && (
                        <div className="mb-2 w-[min(560px,90vw)] overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-2xl">
                            <div className="flex items-center justify-between border-b border-neutral-100 px-5 py-3">
                                ...
                                <button
                                    type="button"
                                    onClick={() => setIsExpanded(false)}
                                    className="flex h-7 w-7 items-center justify-center rounded-full text-neutral-400 transition hover:bg-neutral-100 hover:text-neutral-600"
                                >
                                    <X className="h-4 w-4" />
                                </button>
                            </div>
                    ...
                    {/* Floating pill bar */}
                    <div className="flex items-center gap-3 rounded-full border border-neutral-200/80 bg-white/95 px-4 py-2.5 shadow-xl shadow-black/10 backdrop-blur-xl">
                        <button
                            type="button"

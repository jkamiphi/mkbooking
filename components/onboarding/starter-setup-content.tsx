...
const STARTER_OPTIONS: Array<{
...
}> = [
  {
    ...
    description: "Configura un espacio minimo para cotizar, solicitar y operar como anunciante.",
    eyebrow: "Marca / anunciante",
  },
  {
    type: "AGENCY",
    title: "Crear mi agencia",
    description: "Prepara tu cuenta para operar clientes y centralizar marcas desde una agencia.",
    eyebrow: "Agencia",
  },
];
...
export function StarterSetupContent() {
  ...
  const createStarterOrganization = trpc.organization.createStarterOrganization.useMutation({
    onSuccess: async () => {
      await Promise.all([
  ...
  if (isLoading) {
    return (
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
        <div className="h-[420px] animate-pulse rounded-[2rem] border border-neutral-200/80 bg-white/80" />
        <div className="h-[420px] animate-pulse rounded-[2rem] border border-neutral-200/80 bg-white/70" />
      </div>
    );
  }
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
      <Card className="overflow-hidden rounded-[2rem] border-mkmedia-blue/15 bg-white/92 shadow-[0_32px_120px_-54px_rgba(3,89,168,0.28)] backdrop-blur">
        <CardHeader className="space-y-4 border-b border-mkmedia-blue/10 bg-[linear-gradient(180deg,rgba(3,89,168,0.08),rgba(255,255,255,0))] pb-6">
          ...
          <div className="space-y-2">
            ...
            <CardDescription className="max-w-2xl text-sm leading-6 text-neutral-600">
              Tu cuenta ya esta lista. Si necesitas operar de inmediato, crea una marca o una agencia con solo un nombre. Si ya te compartieron accesos, podras usarlos sin completar datos comerciales ahora.
            </CardDescription>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-6 pt-6">
          {!selectedOption ? (
            <>
              <div className="grid gap-4 md:grid-cols-2">
                {STARTER_OPTIONS.map((option) => (
                  <button
                    ...
                    className="rounded-[1.75rem] border border-neutral-200/80 bg-white p-5 text-left transition hover:border-mkmedia-blue/30 hover:bg-mkmedia-blue/[0.04]"
                  >
              ...
              <div className="rounded-[1.75rem] border border-neutral-200/80 bg-neutral-50/80 p-5">
            ...
            <form onSubmit={handleCreateWorkspace} className="space-y-6">
              ...
              <div className="rounded-[1.75rem] border border-mkmedia-blue/15 bg-mkmedia-blue/6 p-5">
                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-mkmedia-blue [font-family:var(--font-mkmedia)]">
                ...
                <p className="mt-2 text-sm leading-6 text-neutral-600">
                  Solo necesitamos un nombre visible para crear el espacio inicial. Los datos fiscales, legales y de facturacion quedan para despues.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="h-12 rounded-2xl border-mkmedia-blue/15"
                />
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Button
                  ...
                  disabled={
                    createStarterOrganization.isPending || workspaceName.trim().length === 0
                  }
                >
      ...
      <aside className="space-y-4">
        <Card className="rounded-[2rem] border-mkmedia-blue/15 bg-white/88 shadow-[0_26px_80px_-48px_rgba(3,89,168,0.28)]">
          <CardContent className="space-y-4 p-6">
            <div className="flex items-center gap-3">
              <span className="flex h-11 w-11 items-center justify-center rounded-2xl border border-mkmedia-blue/20 bg-mkmedia-blue/8 text-mkmedia-blue">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-neutral-950">
                  Un setup corto y reversible
                </p>
              </div>
            </div>
            <div className="space-y-3 text-sm text-neutral-600">
              <div className="rounded-2xl border border-neutral-200/80 bg-neutral-50 px-4 py-3">
                La cuenta personal y la organizacion ya no se mezclan.
              </div>
              <div className="rounded-2xl border border-neutral-200/80 bg-neutral-50 px-4 py-3">
                Puedes operar una marca propia y, al mismo tiempo, recibir accesos compartidos.
              </div>
              <div className="rounded-2xl border border-mkmedia-yellow/35 bg-mkmedia-yellow/15 px-4 py-3 text-neutral-700">
                El perfil comercial se completa despues, solo cuando haga falta.
              </div>
            </div>
          </CardContent>
        </Card>

        <Card className="rounded-[2rem] border-neutral-200/80 bg-white/82">
          <CardContent className="space-y-4 p-6">
            ...
            <div className="space-y-3 text-sm text-neutral-600">
              <p className="rounded-2xl border border-neutral-200/80 bg-neutral-50 px-4 py-3">
                Crear una marca propia y empezar a solicitar espacios.
              </p>
              <p className="rounded-2xl border border-neutral-200/80 bg-neutral-50 px-4 py-3">
                Crear una agencia propia y sumar clientes despues.
              </p>
              <p className="rounded-2xl border border-neutral-200/80 bg-neutral-50 px-4 py-3">
                Entrar directo a accesos compartidos si otra organizacion ya te invito.
              </p>
            </div>
            <Link
              href="/profile"
              className={cn(
                "inline-flex items-center gap-2 text-sm font-medium text-mkmedia-blue transition hover:text-mkmedia-blue/80",
              )}
            >
              Ver mi perfil
              <ArrowRight className="h-4 w-4" />

  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            "relative flex cursor-pointer items-center gap-1 rounded-md border px-3 py-1.5 text-xs font-semibold shadow-lg transition-all duration-200",
            isSelected
        ...
        >
          <span
            className={cn(
              ...
              isSelected
                ? "border-mkmedia-blue bg-mkmedia-blue"
          ...
          {showPrices && marker.price ? (
            ...
            <span className="h-2 w-2 rounded-md bg-mkmedia-blue" />
          )}
        </div>
      </AdvancedMarker>
        ...
        >
          <div className="min-w-[220px] p-1">
            ...
            <a
              href={marker.href}
              className={cn(
                "mt-3 block w-full rounded-md px-4 py-2 text-center text-xs font-semibold",

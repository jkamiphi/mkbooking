...
> = {
  DRAFT: {
    label: "Borrador",
    variant: "info",
    description: "Tu orden está siendo preparada.",
  },
  QUOTATION_SENT: {
  ...
  CLIENT_APPROVED: {
    ...
    variant: "secondary",
    description: "En revisión de la empresa.",
  },
  CONFIRMED: {
    label: "Confirmada",
    variant: "success",
    description: "Tu campaña está confirmada.",
  },
  CANCELLED: {
    label: "Cancelada",
    variant: "destructive",
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-2 text-xs text-neutral-400">
                  {formatCurrency(String(item.priceDaily))} / día x {item.days}{" "}
                  días
                </p>
              </div>
            </div>
      ...
      <div className="grid gap-5 lg:grid-cols-3">
        ...
        <div className="space-y-5">
            ...
            {order.status === "QUOTATION_SENT" && (
              <div className="mt-6 pt-6 border-t border-neutral-100">
                <p className="mb-4 text-xs text-neutral-500 text-center">
                  Al aprobar esta cotización confirmas que deseas proceder con
                  la campaña bajo estos términos.
                </p>
            ...
            {order.status === "CLIENT_APPROVED" && (
              <div className="mt-6 pt-6 border-t border-neutral-100 text-center">
                ...
                <p className="mt-1 text-xs text-neutral-500">
                  Aprobaste esta cotización. El equipo de MK Booking está por
                  confirmarla.
                </p>
              </div>
            )}
          ...
          <section className="rounded-md border border-neutral-200/80 bg-white p-5">
            ...
            <Badge variant={salesReviewConfig.variant}>
              {salesReviewConfig.label}
            </Badge>
